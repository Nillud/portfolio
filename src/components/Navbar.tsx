...
export function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-1/2 z-50 -translate-x-1/2">
      <nav className="flex items-center gap-2 rounded-full border border-zinc-200 bg-white/70 px-4 py-2 shadow-lg backdrop-blur-xl dark:border-zinc-800 dark:bg-black/70">
        {links.map(link => {
